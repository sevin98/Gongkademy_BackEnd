...
@Tag(name = "[관리자] 질문 API", description = "<h3>- AdminQuestionController</h3>")
public interface AdminQuestionControllerDocs {
    ...
    ResponseEntity<?> getAllQna(@Parameter(description = "페이지 번호", example = "1")
    ...
    ResponseEntity<?> getQna(@PathVariable Long articleNo);
    ...
    ResponseEntity<?> deleteQna(@PathVariable Long articleNo);
