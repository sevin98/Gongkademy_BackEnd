...
@Tag(name = "[유저] 댓글 API", description = "<h3>- CommentController</h3>")
public interface CommentControllerDocs {
    ...
    @ApiResponse(responseCode = "401", description = "인증 실패", content = @Content)
    @ApiResponse(responseCode = "500", description = "서버 오류", content = @Content)
    ResponseEntity<?> toggleLikeCount(@PathVariable Long commentId, @AuthenticationPrincipal PrincipalDetails principalDetails);
}
