...
//        QnaBoard savedQnaBoard = qnaBoardRepository.save(qnaBoard);
//        // 임의로 Request를 생성
//        QnaBoardCreateRequestDTO qnaBoardCreateRequestDto = new QnaBoardCreateRequestDTO();
//        qnaBoardCreateRequestDto.setMemberId(member.getId());
//        qnaBoardCreateRequestDto.setBoardType(qnaBoard.getBoardType());
//        qnaBoardCreateRequestDto.setTitle(updatedTitle);
//
//        // 게시글 수정
//        qnaBoard.update(qnaBoardCreateRequestDto);
//
//        // then
//        // 게시글 객체 조회
//        Optional<QnaBoard> optionalQnaBoard = qnaBoardRepository.findById(savedQnaBoard.getArticleId());
